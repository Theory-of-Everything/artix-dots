...
keys.globalkeys = gears.table.join(
    awful.key({ modkey,           }, "comma",      hotkeys_popup.show_help,
    ...
    -- Prompt
    awful.key({ modkey },            "q",     function () awful.util.spawn("rofi -show run") end,
...
--              {description = "lua execute prompt", group = "awesome"}),
    ...
    -- cmus music control
    awful.key( { modkey,         }, "F5", function() awful.spawn.with_shell("playerctl --player mpd previous") end,
    	      {description = "play previoous song", group = "music"}),
    awful.key( { modkey,         }, "F6", function() awful.spawn.with_shell("playerctl --player mpd play-pause") end,
    	      {description = "toggle music playback", group = "music"}),
    awful.key( { modkey,         }, "F7", function() awful.spawn.with_shell("playerctl --player mpd next") end,
    	      {description = "play next song", group = "music"}),
    awful.key( { modkey,         }, "F8", function() awful.spawn.with_shell("playerctl --player mpd stop") end,
    	      {description = "stop music playback", group = "music"})

    -- scratchpad keys
    --awful.key( { modkey ,         }, "F12", function() awesome.emit_signal("scratch::term")  end,
    --	      {description = "Open Terminal Scratch", group = "scratch"})
)
